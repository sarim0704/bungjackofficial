  ...
  return (
    <main className="min-h-screen bg-[var(--bj-bg)] text-[var(--bj-text)]">
      <section className="relative flex min-h-[calc(100vh-82px)] items-center justify-center overflow-hidden px-6 pb-16 pt-28">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_35%,rgba(37,211,102,0.16),transparent_32%),linear-gradient(90deg,#F6F7F9_0%,rgba(246,247,249,0.96)_100%)] dark:bg-[radial-gradient(circle_at_50%_35%,rgba(37,211,102,0.14),transparent_32%),linear-gradient(90deg,#131311_0%,rgba(19,19,17,0.98)_100%)]" />
        ...
        <div className="relative max-w-xl rounded-[2rem] border border-black/10 bg-white/75 p-8 text-center shadow-[0_24px_80px_rgba(0,0,0,0.10)] backdrop-blur-2xl dark:border-white/10 dark:bg-white/[0.045] dark:shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366]/15 text-red-600">
            <BadgeCheck size={34} />
          </div>

          <p className="premium-label mb-4 uppercase text-red-600">
            Donation Successful
          </p>
          ...
          <p className="mx-auto mt-5 max-w-md text-[15.5px] leading-7 text-[var(--bj-muted)]">
            Your contribution helps keep independent media, public stories, and
            community updates alive.
          </p>
